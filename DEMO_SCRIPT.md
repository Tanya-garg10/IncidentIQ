# IncidentIQ — 3-minute Demo Video Script 🎬

A tight, judge-friendly script. Total runtime ≤ 3:00. Every second is timed.

---

## Pre-recording checklist (do BEFORE you hit record)

1. ✅ Open the dashboard URL (Vercel) in a clean browser window
2. ✅ Wait 30 sec — confirm "live logs" badge says **● connected**
3. ✅ Hit `https://incidentiq-backend-gw17.onrender.com/` in another tab
   first, so Render has woken up (free tier sleeps after 15 min)
4. ✅ Close all unrelated tabs / notifications / Slack etc.
5. ✅ Set browser zoom to 100% (or 110% for visibility)
6. ✅ Bottom of dashboard should show no red errors
7. ✅ Have these ready in Notepad to copy-paste during chat demo:
...
### [0:00 – 0:20] HOOK — set the problem
...
> broke, why, and how to fix it — fast.
>
...
### [0:20 – 0:40] DASHBOARD INTRO — what it is
**Show:** the live dashboard. Mouse hovers over each section briefly.

> "IncidentIQ is an AI-powered incident analysis platform.
> On the left, **live log streams from four services** — auth, payment, user,
> and the API gateway — flowing in real-time over WebSockets.
>
> Right now everything's healthy. Watch what happens when production breaks."

**Point at:** Live Log Stream → Service Health (all green) → Severity meter (Low)

---

### [0:40 – 1:10] SIMULATE THE OUTAGE
**Click:** 🚀 **Mark Deployment** (small button, top right)

> "First, I'll simulate a fresh deployment of payment-service v2.4.1.
> Common scenario — a release just shipped."

**Click:** 🔥 **Simulate Incident** (the big glowing button)

> "Now production breaks."

**Wait 2 seconds. Logs flood in. Point at:**
- Red CRITICAL badges streaming in the log panel
- Severity meter sliding from green → red **Critical**
...
### [1:10 – 1:40] AI ANALYSIS — the killer moment
...
> IncidentIQ doesn't just match keywords — it reads the logs and explains them.
>
...
>
> This is what an SRE does in their head — generated in three seconds."

**Point at the Anomaly Detection card:**
> "On the right, anomaly detection caught the error-rate spike.
> And — this is my favorite part — a **predictive alert**:
...
### [1:40 – 2:15] CHAT WITH YOUR INFRA 🤖
...
**Type:** `Why did payment-service crash?` → press Enter

**Wait for the streaming answer (~2 sec).**

> "It's reading my actual logs in real-time and answering with full context.
> No hallucination — grounded in the data on screen."

**Type one more:** `What should I do to fix this?` → press Enter
...
### [2:15 – 2:40] REPORT EXPORT + TECH STACK
**Click:** ⬇ **Report** button. Markdown file downloads.

> "When the incident's resolved, click Report and it downloads a clean
> markdown postmortem — incident summary, timeline, services affected,
> recommended fixes — ready to paste into Notion or share with your team."
...
4. **Cursor highlighter:** turn on "Show mouse clicks" in OBS so judges
   see what you click.
5. **Cut hard between scenes** — no dead air, no "umm". If you mess up,
...
> failures before they happen, and tell you exactly how to fix them —
> in seconds. Live demo: [URL]"_

Show: simulate incident → AI analysis card → chat → done.
